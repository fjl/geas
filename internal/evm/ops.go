...
var oplist = []*Op{
	...
	{Name: "ADD", Code: 0x1, in: stack{"x", "y"}, out: stack{"x+y"}},
	{Name: "MUL", Code: 0x2, in: stack{"x", "y"}, out: stack{"x*y"}},
	{Name: "SUB", Code: 0x3, in: stack{"x", "y"}, out: stack{"x-y"}},
	{Name: "DIV", Code: 0x4, in: stack{"x", "y"}, out: stack{"x/y"}},
	{Name: "SDIV", Code: 0x5, in: stack{"x", "y"}, out: stack{"x/y"}},
	{Name: "MOD", Code: 0x6, in: stack{"x", "m"}, out: stack{"x%m"}},
	{Name: "SMOD", Code: 0x7, in: stack{"x", "m"}, out: stack{"x%m"}},
	{Name: "ADDMOD", Code: 0x8, in: stack{"x", "y", "m"}, out: stack{"(x+y)%m"}},
	{Name: "MULMOD", Code: 0x9, in: stack{"x", "y", "m"}, out: stack{"(x*y)%m"}},
	{Name: "EXP", Code: 0xa, in: stack{"base", "exponent"}, out: stack{"base**exponent"}},
	{Name: "SIGNEXTEND", Code: 0xb, in: stack{"bytes", "num"}, out: stack{"num_extended"}},
	{Name: "LT", Code: 0x10, in: stack{"x", "y"}, out: stack{"x<y"}},
	{Name: "GT", Code: 0x11, in: stack{"x", "y"}, out: stack{"x>y"}},
	{Name: "SLT", Code: 0x12, in: stack{"x", "y"}, out: stack{"x<y"}},
	{Name: "SGT", Code: 0x13, in: stack{"x", "y"}, out: stack{"x>y"}},
	{Name: "EQ", Code: 0x14, in: stack{"x", "y"}, out: stack{"x==y"}},
	{Name: "ISZERO", Code: 0x15, in: stack{"x"}, out: stack{"x==0"}},
	{Name: "AND", Code: 0x16, in: stack{"x", "y"}, out: stack{"x&y"}},
	{Name: "OR", Code: 0x17, in: stack{"x", "y"}, out: stack{"x|y"}},
	{Name: "XOR", Code: 0x18, in: stack{"x", "y"}, out: stack{"x^y"}},
	{Name: "NOT", Code: 0x19, in: stack{"x"}, out: stack{"~x"}},
	{Name: "BYTE", Code: 0x1a, in: stack{"index", "x"}, out: stack{"x[index]"}},
	{Name: "SHL", Code: 0x1b, in: stack{"s", "x"}, out: stack{"x<<s"}},
	{Name: "SHR", Code: 0x1c, in: stack{"s", "x"}, out: stack{"x>>s"}},
	{Name: "SAR", Code: 0x1d, in: stack{"s", "x"}, out: stack{"x>>s"}},
	{Name: "CLZ", Code: 0x1e, in: stack{"x"}, out: stack{"count"}},
